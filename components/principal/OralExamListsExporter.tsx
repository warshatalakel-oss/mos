...
// FIX: Changed from 25 to 23 as requested
    ...
    const handleExportPdf = async () => {
        ...
        try {
            ...
            for (let i = 0; i < reportPages.length; i++) {
                // FIX: Calculate starting index for continuity
                ...
                await renderComponent(
                    <OralExamListPage
                        ...
                        examRound={examRound}
                        examType={examType}
                        startingIndex={startingIndex} // FIX: Pass startingIndex
                    />
                );
                        ...
                        {reportPages.map((pageStudents, index) => (
                             <div key={index} className="mb-8">
                                <OralExamListPage
                                    ...
                                    examRound={examRound}
                                    examType={examType}
                                    startingIndex={index * STUDENTS_PER_PAGE} // FIX: Pass startingIndex
                                />
                            </div>
                        ))}
                    </div>
